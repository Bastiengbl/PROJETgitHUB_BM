...
def notesS1():
    ...
    "Demarche_Portfolio.xlsx"
        ...
        os.mkdir('notes_S1')
        for y in l:
            shutil.move('/home/etudiant/PROJETgitHUB_BM/data/'+y  , '/home/etudiant/PROJETgitHUB_BM/data/notes_S1/')
notesS1()
...
"Demarche_Portfolio.xlsx"]
    ...
    os.mkdir('notes_S2')
    for y in l:
        shutil.move('/home/etudiant/PROJETgitHUB_BM/data/'+y  , '/home/etudiant/PROJETgitHUB_BM/data/notes_S2/')
